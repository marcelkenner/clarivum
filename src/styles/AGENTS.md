...
`document-theme.css` (Atrament document styles) lives here.

## Rules

- Treat `document-theme.css` as the single source of truth for the document viewer palette (ink and
  accents). Any additions must cite ADR-018 and keep contrast ≥ 4.5:1.
