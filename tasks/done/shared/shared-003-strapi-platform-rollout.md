...
context7:
  ...
  - /websites/aws_amazon-amazoncloudfront-developerguide
tags:
  - cms
  - content
  - localization
...
- [x] Document integration contracts for Next.js, Aurora, and search (versioned GraphQL/REST contracts, publish webhooks revalidating ISR, Aurora read-only entitlements, search indexer payload `{id,type,slug,title,summary,locale,tags}`).
