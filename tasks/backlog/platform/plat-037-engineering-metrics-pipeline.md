...
## Definition of Ready
- [x] Metric definitions/sources locked: DORA 4 metrics from GitHub, CI, incident logs.
- [x] Retention/access documented: 12-month history with Grafana RBAC on dashboards.
- [x] Credentials approach agreed: GitHub App installs plus OIDC, no PATs.
- [x] Hosting/alerting design set: daily job writes to S3/Grafana with failures alerting Platform.
- [x] Anomaly verification playbook drafted to confirm spikes before paging.
