# tasks/sprints/sprint-12 · AGENTS Guide
...
## Scope
- `plan.md` is the single source of truth for Sprint 12 schedule, commitments, and theme; keep the front matter (`id`, `title`, `status`, `start`, `end`, `updated_at`, `links`) aligned with the latest plan.
...
- Reflect material updates in `docs/roadmaps/engineering-roadmap-2025-2026.md` (Spring section) to keep roadmap and sprint plan synchronized.
