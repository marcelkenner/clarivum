# tasks/sprints/sprint-04 · AGENTS Guide
...
## Scope
- `plan.md` is the single source of truth for Sprint 04 schedule, commitments, and theme; keep the front matter (`id`, `title`, `status`, `start`, `end`, `updated_at`, `links`) aligned with the latest plan.
