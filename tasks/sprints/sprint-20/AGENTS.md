# tasks/sprints/sprint-20 · AGENTS Guide
...
## Scope
- `plan.md` is the single source of truth for Sprint 20 schedule, commitments, and theme; keep the front matter (`id`, `title`, `status`, `start`, `end`, `updated_at`, `links`) aligned with the latest plan.
