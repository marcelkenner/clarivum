...
## Overview
These diagrams outline how Auth0, NextAuth.js, and Clarivum’s platform collaborate to secure member and staff access. They cover the identity flows, role mapping into Aurora, and the operational playbook for managing privileged access.

## Files
- `architecture-overview.mmd` — OIDC integrations between Auth0, Next.js, and Aurora.
