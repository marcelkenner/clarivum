...
- `architecture-overview.mmd` — High-level flow of Next.js, Strapi, and external systems interacting with Aurora Schema v0 tables. Update whenever integration points shift.
